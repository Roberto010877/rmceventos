...
const AdminLayout: React.FC = () => {
  ...
  const navItems = [
    ...
    { name: 'Testimonios', path: '/testimonios', icon: MessageSquare, roles: ['editor', 'admin', 'superadmin'], bottomNav: true },
    { name: 'Contactos', path: '/contactos', icon: Mail, roles: ['editor', 'admin', 'superadmin'], bottomNav: true },
